...
double omega, edd, h2, h4, q3, q5, norm_psi2, norm_psi3, ux, uy, uz, murel, xi;
int QF, QDEPL;
...
double *calphax;
double complex **calphay, **calphaz;
double *cgammax;
double complex **cgammay, **cgammaz;
...
void calcmudet(double *, double complex ***, double complex ***, double ***, double ***, double ***, double ***, double ***, fftw_complex *, double **, double **, double **, double **, double **, double **, double complex **, double complex **, double ***, double ***, double ***);
