...
double edd, h2, h4, q3, q5, norm_psi2, norm_psi3, ux, uy, uz, murel, CC[16], LLL, b1, b2, b3, b4;
int QF;
...
fftw_plan plan_transpose_x, plan_transpose_y, plan_transpose_dpsi, plan_transpose_outxyz;
...
void calcmudet(double *, double ***, double ***, double ***, double ***, double ***, double ***, double ***, double ***, fftw_complex *, double **, double **, double **, double **, double **, double **, double ***, double ***, double ***);
...
void calcnu(double ***, double ***, double ***, double ***, double ***, fftw_complex *, double **, double **, double **, double **, double **, double **);
