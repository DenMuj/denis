...
*/
   ...
   fprintf(out, "-------------------------------------------------------------------\n");
   fprintf(out, "Snap      Norm0          Norm           Chem           <r>\n");
   fprintf(out, "-------------------------------------------------------------------\n");
   fflush(out);
   ...
   calcmu(&mu, psi, psi_t, dpsi, dpsi_t, psidd2, psidd2fft, tmpxi, tmpyi, tmpzi, tmpxj, tmpyj, tmpzj);

   fprintf(out, "%-9d %-14.6le %-14.6le %-14.6le %-14.6le\n", 0, norm_psi2, norm_psi2 + h4 * norm_psi3, mu / par / norm_psi2, *rms / sqrt(norm_psi2));
   fflush(out);
   ...
   for (snap = 1; snap <= Nsnap; snap ++) {
      ...
      fprintf(out, "%-9li %-14.6le %-14.6le %-14.6le %-14.6le\n", snap, norm_psi2, norm_psi2 + h4 * norm_psi3, mu / par / norm_psi2, *rms / sqrt(norm_psi2));
      fflush(out);
