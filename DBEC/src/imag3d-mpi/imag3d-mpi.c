 ...
 */
void initpsi(double ***psi, double *tmpz) {
   long cnti, cntj, cntk;
   double cpsi;
   double tmp;
 ...
 */
void calcmuen(double *mu, double *en, double ***psi, double ***psi_t, double ***dpsi, double ***dpsi_t, double ***psidd2, fftw_complex *psidd2fft, double **tmpxi, double **tmpyi, double **tmpzi, double **tmpxj, double **tmpyj, double **tmpzj) {
   int threadid;
   long cnti, cntj, cntk;
...
void calcpsidd2(double ***psi, double ***psidd2, fftw_complex *psidd2fft) {
   ...
   for (cnti = 0; cnti < localNx; cnti ++) {
      for (cntj = 0; cntj < Ny; cntj ++) {
         for (cntk = 0; cntk < Nz; cntk ++) {
            psidd2[cnti][cntj][cntk] = psi[cnti][cntj][cntk] * psi[cnti][cntj][cntk];
         }
      }
   }
