...
#include "imag3d-mpi-qf-mu-self-rnd.h"
   ...
   if (input != NULL) {
      ...
      for (cnti = 0; cnti < localNx; cnti ++) {
         for (cntj = 0; cntj < Ny; cntj ++) {
            ...
            for (cntk = 0; cntk < Nz; cntk ++) {
               psi[cnti][cntj][cntk] = (1. + 0.01 * drand48()) * sqrt(tmpr[cntk]);
            }
      ...
      for (cnti = 0; cnti < localNx; cnti ++) {
         for (cntj = 0; cntj < Ny; cntj ++) {
            for (cntk = 0; cntk < Nz; cntk ++) {
               ...
               psi[cnti][cntj][cntk] = (1. + 0.01 * drand48()) * tmp / cpsi;
            }
         }
      }
   }
