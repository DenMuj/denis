...
#include "imag3d-mpi-qf-grad-mu-self.h"
...
int main(int argc, char **argv) {
   ...
   double norm, mu[7], mutot, mutotold;
   double *rms;
   double **cbeta;
   double ***psi, ***psi_t;
   double ***dpsi, ***dpsi_t;
   ...
   LLL = edd == 1. ? 0. : log((-1 + edd)/(1 + 5*edd + 2*sqrt(3.)*sqrt(edd)*sqrt(1 + 2*edd)));

   CC[1] = (-30*sqrt(edd)*sqrt(1 + 2*edd) - 500*pow(edd,1.5)*sqrt(1 + 2*edd) + 74*pow(edd,2.5)*sqrt(1 + 2*edd) + 
     sqrt(3.)*pow(-1 + edd,2)*(-5 + 43*edd)*LLL)/(1152.*pow(edd,1.5)*sqrt(pi));
   CC[2] = CC[1];

   CC[3] = (30*sqrt(edd)*sqrt(1 + 2*edd) - 160*pow(edd,1.5)*sqrt(1 + 2*edd) - 98*pow(edd,2.5)*sqrt(1 + 2*edd) - 
     sqrt(3.)*(-1 + edd)*(5 + edd*(54 + 31*edd))*LLL)/(576.*pow(edd,1.5)*sqrt(pi));

   CC[4] = (-5*(6*sqrt(edd)*sqrt(1 + 2*edd) + 4*pow(edd,1.5)*sqrt(1 + 2*edd) - 34*pow(edd,2.5)*sqrt(1 + 2*edd) + 
       sqrt(3.)*pow(-1 + edd,2)*(1 + edd)*LLL))/(1152.*pow(edd,1.5)*sqrt(pi));
   CC[5] = CC[4];

   CC[6] = (5*(6*sqrt(edd)*sqrt(1 + 2*edd) + 16*pow(edd,1.5)*sqrt(1 + 2*edd) - 10*pow(edd,2.5)*sqrt(1 + 2*edd) + 
       sqrt(3.)*(1 + edd*(5 + (5 - 11*edd)*edd))*LLL))/(576.*pow(edd,1.5)*sqrt(pi));

   CC[7] = (5*(6*sqrt(edd)*sqrt(1 + 2*edd) + 4*pow(edd,1.5)*sqrt(1 + 2*edd) - 34*pow(edd,2.5)*sqrt(1 + 2*edd) + 
       sqrt(3.)*pow(-1 + edd,2)*(1 + edd)*LLL))/(192.*pow(edd,1.5)*sqrt(pi));
   CC[8] = CC[7];

   CC[9] = (5*(-6*sqrt(edd)*sqrt(1 + 2*edd) - 16*pow(edd,1.5)*sqrt(1 + 2*edd) + 10*pow(edd,2.5)*sqrt(1 + 2*edd) - 
       sqrt(3.)*(1 + edd*(5 + (5 - 11*edd)*edd))*LLL))/(96.*pow(edd,1.5)*sqrt(pi));

   CC[10] = (30*sqrt(edd)*sqrt(1 + 2*edd) - 40*pow(edd,1.5)*sqrt(1 + 2*edd) - 182*pow(edd,2.5)*sqrt(1 + 2*edd) + 
     sqrt(3.)*pow(-1 + edd,2)*(5 + 11*edd)*LLL)/(288.*pow(edd,1.5)*sqrt(pi));
   CC[11] = CC[10];

   CC[12] = (-30*sqrt(edd)*sqrt(1 + 2*edd) - 110*pow(edd,1.5)*sqrt(1 + 2*edd) + 44*pow(edd,2.5)*sqrt(1 + 2*edd) + 
     sqrt(3.)*(-1 + edd)*(5 + edd*(27 + 58*edd))*LLL)/(144.*pow(edd,1.5)*sqrt(pi));

   CC[13] = (30*sqrt(edd)*sqrt(1 + 2*edd) + 200*pow(edd,1.5)*sqrt(1 + 2*edd) - 134*pow(edd,2.5)*sqrt(1 + 2*edd) - 
     sqrt(3.)*pow(-1 + edd,2)*(-5 + 13*edd)*LLL)/(288.*pow(edd,1.5)*sqrt(pi));
   CC[14] = CC[13];

   CC[15] = (-30*sqrt(edd)*sqrt(1 + 2*edd) + 10*pow(edd,1.5)*sqrt(1 + 2*edd) + 68*pow(edd,2.5)*sqrt(1 + 2*edd) - 
     sqrt(3.)*(5 + edd*(34 + (7 - 46*edd)*edd))*LLL)/(144.*pow(edd,1.5)*sqrt(pi));

   b1 = GRAD * (CC[1] + CC[4] + CC[7]) * pow(as * BOHR_RADIUS / aho, 1.5) * sqrt(Na);
   b2 = GRAD * (CC[3] + CC[6] + CC[9]) * pow(as * BOHR_RADIUS / aho, 1.5) * sqrt(Na);
   b3 = GRAD * (CC[10] + CC[13]) * pow(as * BOHR_RADIUS / aho, 1.5) * sqrt(Na);
   b4 = GRAD * (CC[12] + CC[15]) * pow(as * BOHR_RADIUS / aho, 1.5) * sqrt(Na);
   ...
   if (muoutput != NULL) tmpxmui = alloc_double_tensor(7, nthreads, Nx);
   if (muoutput != NULL) tmpymui = alloc_double_tensor(7, nthreads, Ny);
   if (muoutput != NULL) tmpzmui = alloc_double_tensor(7, nthreads, Nz);
   ...
   outxyz = alloc_double_tensor(localNx, Ny, Nz);
   outxyz_t = alloc_double_tensor(Nx, localNy, Nz);
   ...
   if (QF == 1) {
      fprintf(out, "QF = 1: h2 = %.6le, h4 = %.6le\n        q3 = %.6le, q5 = %.6le\n", h2, h4, q3, q5);
      fprintf(out, "        b1 = %.6le, b2 = %.6le, b3 = %.6le, b4 = %.6le\n\n", b1, b2, b3, b4);
   ...
   if (muoutput != NULL) {
      fprintf(muout, "-------------------------------------------------------------------------------------------------------------------------------\n");
      fprintf(muout, "Snap      mu             Kin            Pot            Contact        DDI            Dmu(Contact)   Dmu(DDI)       Dmu(grad)\n");
      fprintf(muout, "-------------------------------------------------------------------------------------------------------------------------------\n");
      fflush(muout);
   }
   ...
   plan_transpose_x = fftw_mpi_plan_many_transpose(Nx, Ny * Nz, 1, localNx, localNy * Nz, **psi, **psi_t, MPI_COMM_WORLD, FFT_FLAG | FFTW_MPI_TRANSPOSED_OUT);
   plan_transpose_y = fftw_mpi_plan_many_transpose(Ny * Nz, Nx, 1, localNy * Nz, localNx, **psi_t, **psi, MPI_COMM_WORLD, FFT_FLAG | FFTW_MPI_TRANSPOSED_IN);
   plan_transpose_dpsi = fftw_mpi_plan_many_transpose(Ny * Nz, Nx, 1, localNy * Nz, localNx, **dpsi_t, **dpsi, MPI_COMM_WORLD, FFT_FLAG | FFTW_MPI_TRANSPOSED_IN);
   plan_transpose_outxyz = fftw_mpi_plan_many_transpose(Ny * Nz, Nx, 1, localNy * Nz, localNx, **outxyz_t, **outxyz, MPI_COMM_WORLD, FFT_FLAG | FFTW_MPI_TRANSPOSED_IN);
   ...
   if (muoutput != NULL) {
      calcmudet(mu, psi, psi_t, dpsi, dpsi_t, outxyz, outxyz_t, psidd2, psidd20, psidd2fft, tmpxi, tmpyi, tmpzi, tmpxj, tmpyj, tmpzj, tmpxmui, tmpymui, tmpzmui);

      mutot = 0.;
      for (cnte = 0; cnte < 7; cnte ++) {
         mu[cnte] /= par * norm_psi2;
         mutot += mu[cnte];
      }

      fprintf(muout, "%-9d %-14.6le %-14.6le %-14.6le %-14.6le %-14.6le %-14.6le %-14.6le %-14.6le\n", 0, mutot, mu[0], mu[1], mu[2], mu[3], mu[4], mu[5], mu[6]);
      fflush(muout);
   } else {
      calcmu(&mutot, psi, psi_t, dpsi, dpsi_t, psidd2, psidd2fft, tmpxi, tmpyi, tmpzi, tmpxj, tmpyj, tmpzj);
      mutot /= par * norm_psi2;
   }
   ...
   for (snap = 1; snap <= Nsnap; snap ++) {
      for (cnti = 0; cnti < nsteps; cnti ++) {
         calcnu(psi, psi_t, dpsi, dpsi_t, psidd2, psidd2fft, tmpxi, tmpyi, tmpzi, tmpxj, tmpyj, tmpzj);
         calcluy(psi, cbeta);
         calcluz(psi, cbeta);
         calclux(psi_t, cbeta);
         calcnorm(&norm, psi, tmpxi, tmpyi, tmpzi);
      ...
      if (muoutput != NULL) {
         ...
         fprintf(muout, "%-9li %-14.6le %-14.6le %-14.6le %-14.6le %-14.6le %-14.6le %-14.6le %-14.6le\n", snap, mutot, mu[0], mu[1], mu[2], mu[3], mu[4], mu[5], mu[6]);
         fflush(muout);
      } else {
         calcmu(&mutot, psi, psi_t, dpsi, dpsi_t, psidd2, psidd2fft, tmpxi, tmpyi, tmpzi, tmpxj, tmpyj, tmpzj);                            
         mutot /= par * norm_psi2;
   ...
   fftw_destroy_plan(plan_transpose_outxyz);
   ...
   free_double_tensor(outxyz);
   free_double_tensor(outxyz_t);
...
void readpar(void) {
   ...
   if ((cfg_tmp = cfg_read("UX")) == NULL) ux = 0.;
   else ux = atof(cfg_tmp);

   if ((cfg_tmp = cfg_read("UY")) == NULL) uy = 0.;
   else uy = atof(cfg_tmp);
   ...
   if ((Niterout != NULL) || (finalout != NULL)) {
...
void initpsi(double ***psi) {
   ...
   if (input != NULL) {
      ...
      cpsi = sqrt(pi * sqrt(pi) * ux * uy * uz);

      #pragma omp parallel for private(cnti, cntj, cntk, tmp)
      for (cnti = 0; cnti < localNx; cnti ++) {
         for (cntj = 0; cntj < Ny; cntj ++) {
            for (cntk = 0; cntk < Nz; cntk ++) {
               tmp = exp(- 0.5 * (x2[offsetNx + cnti] / (ux * ux) + y2[cntj] / (uy * uy) + z2[cntk] / (uz * uz)));
...
void calcnorm(double *norm, double ***psi, double **tmpx, double **tmpy, double **tmpz) {
   ...
   #pragma omp parallel private(threadid, cnti, cntj, cntk)
   {
       ...
       for (cnti = 0; cnti < localNx; cnti ++) {
         for (cntj = 0; cntj < Ny; cntj ++) {
            for (cntk = 0; cntk < Nz; cntk ++) {
               tmpz[threadid][cntk] = psi[cnti][cntj][cntk] * psi[cnti][cntj][cntk] * psi[cnti][cntj][cntk];
            }
            tmpy[threadid][cntj] = simpint(dz, tmpz[threadid], Nz);
         }
         (*tmpx)[cnti] = simpint(dy, tmpy[threadid], Ny);
 ...
 */
void calcmudet(double *mu, double ***psi, double ***psi_t, double ***dpsi, double ***dpsi_t, double ***outxyz, double ***outxyz_t, double ***psidd2, double ***psidd20, fftw_complex *psidd2fft, double **tmpxi, double **tmpyi, double **tmpzi, double **tmpxj, double **tmpyj, double **tmpzj, double ***tmpxmui, double ***tmpymui, double ***tmpzmui) {
   int threadid;
   long cnti, cntj, cntk, cnte;
   double psi2, psi3, kpar;
   void *sendbuf;
   ...
   #pragma omp parallel private(threadid, cnti, cntj, cntk)
   {
      ...
      for (cntj = 0; cntj < localNy; cntj ++) {
         for (cntk = 0; cntk < Nz; cntk ++) {
            ...
            diff(dx, tmpxj[threadid], tmpxi[threadid], Nx);
            for (cnti = 0; cnti < Nx; cnti ++) {
               dpsi_t[cnti][cntj][cntk] = tmpxj[threadid][cnti] * tmpxj[threadid][cnti];
               outxyz_t[cnti][cntj][cntk] = b1 * tmpxj[threadid][cnti] * tmpxj[threadid][cnti] * psi_t[cnti][cntj][cntk] +
                                            b3 * tmpxi[threadid][cnti] * psi_t[cnti][cntj][cntk] * psi_t[cnti][cntj][cntk];
            }
         }
      }
   }
   ...
   fftw_execute(plan_transpose_outxyz);
   ...
   #pragma omp parallel private(threadid, cnti, cntj, cntk)
   {
      ...
      for (cnti = 0; cnti < localNx; cnti ++) {
         for (cntk = 0; cntk < Nz; cntk ++) {
            ...
            diff(dy, tmpyj[threadid], tmpyi[threadid], Ny);
            for (cntj = 0; cntj < Ny; cntj ++) {
               dpsi[cnti][cntj][cntk] += tmpyj[threadid][cntj] * tmpyj[threadid][cntj];
               outxyz[cnti][cntj][cntk] += b1 * tmpyj[threadid][cntj] * tmpyj[threadid][cntj] * psi[cnti][cntj][cntk] +
                                           b3 * tmpyi[threadid][cntj] * psi[cnti][cntj][cntk] * psi[cnti][cntj][cntk];
            }
         }
      }
      ...
      for (cnti = 0; cnti < localNx; cnti ++) {
         for (cntj = 0; cntj < Ny; cntj ++) {
            ...
            diff(dz, tmpzj[threadid], tmpzi[threadid], Nz);
            for (cntk = 0; cntk < Nz; cntk ++) {
               dpsi[cnti][cntj][cntk] += tmpzj[threadid][cntk] * tmpzj[threadid][cntk];
               outxyz[cnti][cntj][cntk] += b2 * tmpzj[threadid][cntk] * tmpzj[threadid][cntk] * psi[cnti][cntj][cntk] +
                                           b4 * tmpzi[threadid][cntk] * psi[cnti][cntj][cntk] * psi[cnti][cntj][cntk];
            }
         }
      }
   }
   ...
   #pragma omp parallel private(threadid, cnti, cntj, cntk, cnte, psi2, psi3)
   {
      threadid = omp_get_thread_num();
      ...
      for (cnti = 0; cnti < localNx; cnti ++) {
         for (cntj = 0; cntj < Ny; cntj ++) {
            for (cntk = 0; cntk < Nz; cntk ++) {
               ...
               tmpzmui[6][threadid][cntk] = kpar * outxyz[cnti][cntj][cntk];
            }
            for (cnte = 0; cnte < 7; cnte ++) tmpymui[cnte][threadid][cntj] = simpint(dz, tmpzmui[cnte][threadid], Nz);
         }
         for (cnte = 0; cnte < 7; cnte ++) tmpxmui[cnte][0][cnti] = simpint(dy, tmpymui[cnte][threadid], Ny);
      }
   }
   ...
   if (rank == 0) for (cnte = 0; cnte < 7; cnte ++) mu[cnte] = simpint(dx, tmpxmui[cnte][0], Nx);

   return;
}

void calcmu(double *mu, double ***psi, double ***psi_t, double ***dpsi, double ***dpsi_t, double ***psidd2, fftw_complex *psidd2fft, double **tmpxi, double **tmpyi, double **tmpzi, double **tmpxj, double **tmpyj, double **tmpzj) {
   int threadid;
   long cnti, cntj, cntk;
   double dpsi2, psi2, psi3, psi2lin, psidd2lin, kpar;
   void *sendbuf;
   ...
   #pragma omp parallel private(threadid, cnti, cntj, cntk)
   {
      ...
      for (cntj = 0; cntj < localNy; cntj ++) {
         for (cntk = 0; cntk < Nz; cntk ++) {
            ...
            diff(dx, tmpxj[threadid], tmpxi[threadid], Nx);
            for (cnti = 0; cnti < Nx; cnti ++) {
               dpsi_t[cnti][cntj][cntk] = tmpxj[threadid][cnti] * tmpxj[threadid][cnti] * (1. + b1 * psi_t[cnti][cntj][cntk]) +
                                          b3 * tmpxi[threadid][cnti] * psi_t[cnti][cntj][cntk] * psi_t[cnti][cntj][cntk];
            }
         }
      }
   ...
   #pragma omp parallel private(threadid, cnti, cntj, cntk, dpsi2, psi2, psi3, psi2lin, psidd2lin)
   {
      threadid = omp_get_thread_num();
      ...
      for (cnti = 0; cnti < localNx; cnti ++) {
         for (cntk = 0; cntk < Nz; cntk ++) {
            ...
            diff(dy, tmpyj[threadid], tmpyi[threadid], Ny);
            for (cntj = 0; cntj < Ny; cntj ++) {
               dpsi[cnti][cntj][cntk] += tmpyj[threadid][cntj] * tmpyj[threadid][cntj] * (1. + b1 * psi[cnti][cntj][cntk]) +
                                         b3 * tmpyi[threadid][cntj] * psi[cnti][cntj][cntk] * psi[cnti][cntj][cntk];
            }
         }
      }
      ...
      for (cnti = 0; cnti < localNx; cnti ++) {
         for (cntj = 0; cntj < Ny; cntj ++) {
            ...
            diff(dz, tmpzj[threadid], tmpzi[threadid], Nz);
            for (cntk = 0; cntk < Nz; cntk ++) {
               dpsi[cnti][cntj][cntk] += tmpzj[threadid][cntk] * tmpzj[threadid][cntk] * (1. + b2 * psi[cnti][cntj][cntk]) +
                                         b4 * tmpzi[threadid][cntk] * psi[cnti][cntj][cntk] * psi[cnti][cntj][cntk];
            }
         }
      }
 ...
 *    psidd2fft - array with the squared wave function fft values
 */
void calcpsidd2(double ***psi, double ***psidd2, fftw_complex *psidd2fft) {
   long cnti, cntj, cntk;
   long last = 0;
   double *psidd2tmp = (double *) psidd2fft;
   double psi2;

   #pragma omp parallel for private(cnti, cntj, cntk, psi2)
   for (cnti = 0; cnti < localNx; cnti ++) {
      for (cntj = 0; cntj < Ny; cntj ++) {
         for (cntk = 0; cntk < Nz; cntk ++) {
            psi2 = psi[cnti][cntj][cntk] * psi[cnti][cntj][cntk];
            psidd2[cnti][cntj][cntk] = psi2 * (1 + h4 * psi[cnti][cntj][cntk]);;
         }
      }
   }
...
void calcpsidd20(double ***psi, double ***psidd20, fftw_complex *psidd2fft) {            
   long cnti, cntj, cntk;
   long last = 0;
   double *psidd2tmp = (double *) psidd2fft;
   double psi2;
 ...
 *    psidd2fft - array with the squared wave function fft values
 */
void calcnu(double ***psi, double ***psi_t, double ***dpsi, double ***dpsi_t, double ***psidd2, fftw_complex *psidd2fft, double **tmpxi, double **tmpyi, double **tmpzi, double **tmpxj, double **tmpyj, double **tmpzj) {
   int threadid;
   long cnti, cntj, cntk;
   ...
   #pragma omp parallel private(threadid, cnti, cntj, cntk)
   {
      ...
      for (cntj = 0; cntj < localNy; cntj ++) {
         for (cntk = 0; cntk < Nz; cntk ++) {
            ...
            diff(dx, tmpxj[threadid], tmpxi[threadid], Nx);
            for (cnti = 0; cnti < Nx; cnti ++) {
               dpsi_t[cnti][cntj][cntk] = b1 * tmpxj[threadid][cnti] * tmpxj[threadid][cnti] / (psi_t[cnti][cntj][cntk] + EPSILON) +
                                          b3 * tmpxi[threadid][cnti];
            }
         }
      }
   }
   ...
   #pragma omp parallel private(threadid, cnti, cntj, cntk)
   {
      ...
      for (cnti = 0; cnti < localNx; cnti ++) {
         for (cntk = 0; cntk < Nz; cntk ++) {
            ...
            diff(dy, tmpyj[threadid], tmpyi[threadid], Ny);
            for (cntj = 0; cntj < Ny; cntj ++) {
               dpsi[cnti][cntj][cntk] += b1 * tmpyj[threadid][cntj] * tmpyj[threadid][cntj]  / (psi[cnti][cntj][cntk] + EPSILON) +
                                         b3 * tmpyi[threadid][cntj];
            }
         }
      }
      ...
      for (cnti = 0; cnti < localNx; cnti ++) {
         for (cntj = 0; cntj < Ny; cntj ++) {
            ...
            diff(dz, tmpzj[threadid], tmpzi[threadid], Nz);
            for (cntk = 0; cntk < Nz; cntk ++) {
               dpsi[cnti][cntj][cntk] += b2 * tmpzj[threadid][cntk] * tmpzj[threadid][cntk] / (psi[cnti][cntj][cntk] + EPSILON) +
                                         b4 * tmpzi[threadid][cntk];
            }
         }
      }
   }
   ...
   for (cnti = 0; cnti < localNx; cnti ++) {
      for (cntj = 0; cntj < Ny; cntj ++) {
         for (cntk = 0; cntk < Nz; cntk ++) {
            ...
            psi2lin = g * psi2;
            psidd2lin = gd * psidd2[cnti][cntj][cntk];
            tmp = dt * (pot[cnti][cntj][cntk] + psi2lin + psidd2lin + h2 * psi3 + dpsi[cnti][cntj][cntk]);
