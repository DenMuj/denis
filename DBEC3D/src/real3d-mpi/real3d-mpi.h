...
char *input, *output, *rmsout, *initout, *Npasout, *finalout;
...
void calcmuen(double *, double *, double complex ***, double complex ***, double ***, double ***, double ***, fftw_complex *, double **, double **, double **, double **, double **, double **);
