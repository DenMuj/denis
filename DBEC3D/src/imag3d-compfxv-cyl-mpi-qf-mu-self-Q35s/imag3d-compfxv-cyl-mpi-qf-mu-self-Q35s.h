...
double edd, h2, h4, q3, q5, norm_psi2, norm_psi3, urho, uz, murel, xi;
int QF, QDEPL;
...
long Nx, Ny, Nz;
int rank, nprocs;
long localNx, localNy, localNz, offsetNx, offsetNy;
long Nx2, Ny2, Nz2;
double g, gd;
...
double Ax0, Ay0, Az0, Ax0r, Ay0r, Az0r, Ax, Ay, Az, dAy;
...
void calcluy(double complex ***, double complex **, double complex **);
