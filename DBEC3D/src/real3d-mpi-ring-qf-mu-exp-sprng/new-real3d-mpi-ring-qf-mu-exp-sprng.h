...
char *input, *input_type, *output, *muoutput, *rmsout, *Niterout, *finalden, *finalpsi;
long outstpx, outstpy, outstpz;

double edd, h2, h4, q3, q5, norm, norm_psi2, norm_psi3, Rring;
int QF;
Sprng *stream;
int nstreams, streamnum, nans, nanscurr;
long seed = 2712973;

int opt;
long Na;
long Niter1, Niter2, Nsnap, itercurr;
long Nx, Ny, Nz;
int rank, nprocs;
long localNx, localNy, offsetNx, offsetNy;
long Nx2, Ny2, Nz2;
double g, g0, g1, dg, gd;
double aho, tau, as, as0, as1, das, add;
double dx, dy, dz;
double dx2, dy2, dz2;
double dt;
...
void calcnorm(double *, double complex ***, double **, double **, double **, double **, double **, double **);
void donorm(double, double complex ***);
void calcmu(double *, double complex ***, double complex ***, double ***, double ***, double ***, fftw_complex *, double **, double **, double **, double **, double **, double **, double complex **, double complex **);
void calcmudet(double *, double complex ***, double complex ***, double ***, double ***, double ***, double ***, fftw_complex *, double **, double **, double **, double **, double **, double **, double complex **, double complex **, double ***, double ***, double ***);
