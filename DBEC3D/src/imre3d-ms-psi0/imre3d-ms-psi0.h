...
char *input, *input_type, *output, *muoutput, *rmsout, *Niterout, *finalpsi, final[MAX_FILENAME_SIZE];
long outstpx, outstpy, outstpz;

double omega, edd, h2, h4, q3, q5, norm_psi2, norm_psi3, ux, uy, uz, murel, CC[16];
double complex LLL;
int QF, QDEPL, GRAD;
