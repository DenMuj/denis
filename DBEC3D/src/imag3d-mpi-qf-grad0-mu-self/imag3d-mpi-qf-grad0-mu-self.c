...
#include "imag3d-mpi-qf-grad0-mu-self.h"
...
int main(int argc, char **argv) {
   ...
   b1 = 0.; //(CC[1] + CC[4] + CC[7]) * pow(as * BOHR_RADIUS / aho, 1.5) * sqrt(Na);
   b2 = 0.; //(CC[3] + CC[6] + CC[9]) * pow(as * BOHR_RADIUS / aho, 1.5) * sqrt(Na);
   b3 = 0.; //(CC[10] + CC[13]) * pow(as * BOHR_RADIUS / aho, 1.5) * sqrt(Na);
   b4 = 0.; //(CC[12] + CC[15]) * pow(as * BOHR_RADIUS / aho, 1.5) * sqrt(Na);
