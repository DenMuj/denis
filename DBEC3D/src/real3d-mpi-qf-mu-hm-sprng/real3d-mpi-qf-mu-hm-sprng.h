...
double edd, h2, h4, q3, q5, norm_psi2, norm_psi3;
int QF, QDEPL;
Sprng *stream;
int nstreams, streamnum;
long seed = 2712973;
...
double dx2, dy2, dz2;
double dt;
double vgamma, vnu, vlambda, vomegam, vgamma2, vnu2, vlambda2, vnu2t, vlambda2t, eps, omegamt, osc;
double par;
double pi, cutoff;
...
void calcdonorm(double *, double complex ***, double **, double **, double **);
